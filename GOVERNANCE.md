...
* Provide a learning environment for Vulkan
  * Provide a simple framework to experiment with Vulkan
  * Eventually expand to support Demo-scene style applications
* Platform support:
  * Windows
  * Linux
  * All others **TBD**
